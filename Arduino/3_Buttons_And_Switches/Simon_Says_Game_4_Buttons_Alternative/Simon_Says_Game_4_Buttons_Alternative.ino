...
/* Pin settings */
static const int Game::MICROPHONE_PIN       = 8;
static const int Game::BLUE_PIN             = 2;
static const int Game::RED_PIN              = 9;
static const int Game::GREEN_PIN            = 11;
static const int Game::YELLOW_PIN           = 5;
static const int Game::BLUE_BUTTON_PIN      = 3;
static const int Game::RED_BUTTON_PIN       = 10;
static const int Game::GREEN_BUTTON_PIN     = 12;
static const int Game::YELLOW_BUTTON_PIN    = 6;
/* Tone frequencies */
