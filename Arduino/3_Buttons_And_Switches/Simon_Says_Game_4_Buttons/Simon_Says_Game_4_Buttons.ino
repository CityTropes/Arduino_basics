...
int button[] = {10, 6, 7, 3};  //red is button[0], yellow is button[1], green is button[2], blue is button[3]
int led[] = {9, 5, 11, 2};     //red is led[0], yellow is led[1], green is led[2], blue is led[3]
int tones[] = {392, 330, 494, 262};   //tones to play with each button (c, e, g, b)
...
int buttonSequence[12];       //make an array of numbers that will be the sequence that the player needs to remember

int buzzerPin = 8;           //pin that the buzzer is connected to
